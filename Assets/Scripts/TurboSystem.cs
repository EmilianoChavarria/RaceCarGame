...
public class TurboSystem : MonoBehaviour
{
    ...
    /// <summary>
    /// Reinicia el turbo a su estado inicial (llamar al terminar una vuelta)
    /// </summary>
    public void ResetTurboForNewLap()
    {
        currentTurboFuel = maxTurboFuel;
        currentState = TurboState.Ready;
        stateTimer = 0f;
        Debug.Log("[TURBO] Turbo reiniciado para nueva vuelta. Combustible al máximo.");
    }
